...
import 'patientintake_model.dart';
export 'patientintake_model.dart';

class PatientintakeWidget extends StatefulWidget {
  const PatientintakeWidget({super.key});

  static String routeName = 'Patientintake';
  static String routePath = '/patientintake';

  @override
  State<PatientintakeWidget> createState() => _PatientintakeWidgetState();
}
...
class _PatientintakeWidgetState extends State<PatientintakeWidget> {
  ...
  void initState() {
    ...
    _model.conditionFocusNode!.addListener(() => safeSetState(() {}));
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      filled: true,
                                      fillColor: (_model.conditionFocusNode
                                                  ?.hasFocus ??
                                              false)
                                          ? FlutterFlowTheme.of(context).accent1
                                          : FlutterFlowTheme.of(context)
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    FFAppState().PatientInfo =
                                        <String, dynamic>{
                                      'name': _model.nameTextController.text,
                                      'age': _model.ageTextController.text,
                                      'condition':
                                          _model.conditionTextController.text,
                                    };
                                    FFAppState().taskDescription =
